...
export const ABOUT_TEXT = `I am a dedicated MERN Stack Developer with a Master's in Computer Applications and hands-on experience in designing and developing robust web solutions. Over the past few years, I’ve had the opportunity to work on a variety of projects, from e-commerce platforms to real-time dashboards, leveraging my skills in JavaScript, React.js, and Node.js. My approach is to combine a deep understanding of front-end and back-end technologies with a proactive mindset towards problem-solving and code optimization. I thrive in collaborative environments, enjoy tackling complex challenges, and am committed to delivering high-quality applications. Outside of coding, I stay active by keeping up with industry trends and continuously learning new technologies.`;
...
export const CONTACT = {
  ...
  phoneNo: "+971 56 559 1596 ",
  email: "ahbarajaib@gmail.com",
};
